...
public class T07_GroupThread {
	...
	public static void main(String[] args) {
		...
		Thread th1 = new Thread(grp1, r, "thread1");
		...
		System.out.println("Active ThreadGroup's amount : " + main.activeGroupCount());
		System.out.println("Active Thread's amount : " + main.activeCount());
